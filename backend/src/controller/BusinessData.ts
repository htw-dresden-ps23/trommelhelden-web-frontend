import { Prisma, PrismaClient, Rechnung , Auftrag, Montage, Mitarbeiter} from "@prisma/client";
  ...
  async getSalesEmployees(
    ...
    switch (calcType) {
      ...
      case "backend": {
        ...
        let foundMitarbeiter: any = mitarbeiter.find(mitarbeiter => mitarbeiter.MitID === filter)
        ...
        for (let auftrag of foundAuftraege){
          let foundRechnung: any = rechnungen.find(rechnung => rechnung.AufNr === auftrag.Aufnr)
